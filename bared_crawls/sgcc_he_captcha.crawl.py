...
class SGCC_Captcha_Crawler:
    """
        国家电网: captcha/get
        {
            ...
            "repData": {
                ...
                "secretKey": "aevM4o4UWvsMMPF8",
                "originalImageBase64": "bHMfFL4zR2hF1vhZ4aT31ksf2fF9ePDqms/Gnz/bOH15fCePuU3p3v/eHr6L88uvdzKPD",
                "point": null,
                "jigsawImageBase64": "iVBORw0KGgoAAAANSUhEUgAAAC8AAACbCAYAAADyfMLPAAAJaElEQVR42u1a+28U1xUOsb2P",
                "wordList": null,
                "pointList": null,
                "pointJson": null,
                "token": "d03814f51fb742de8235d2406f77f1f9",
                "result": false,
    ...
    def __init__(self, delay: float = 2.0, timeout: int = 10):
        ...
        self.url = "https://pmos.he.sgcc.com.cn/px-common-authcenter/auth/v2/captcha/get"
        self.headers = {
            'X-Ticket': 'undefined',
            'sec-ch-ua-platform': '"macOS"',
            'Referer': 'https://pmos.he.sgcc.com.cn/',
...
def main():
    ...
    parser.add_argument('--output', type=str, default='cache/sgcc_he_captcha.json', help='输出文件路径（默认: cache/sgcc_he_captcha.json）')
    args = parser.parse_args()

    # 初始化
    cache_manager = CacheManager(args.output)
    crawler = SGCC_Captcha_Crawler(delay=args.delay)
